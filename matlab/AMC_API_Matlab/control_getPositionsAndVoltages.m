...
% brief : Simultaneously get 3 axes positions as well as the DC offset position-value is -2147483648 nm, if sensor is disabled or no positioner is connected.
%
...
data_send = sprintf('{"jsonrpc": "2.0", "pid": "amc", "method": "com.attocube.amc.control.getPositionsAndVoltages", "params": [], "id": 1, "api": 2}');
