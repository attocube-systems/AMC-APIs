...
function [errNo, value_present] = res_getSensorStatus(tcp, axis)
...
data_send = sprintf('{"jsonrpc": "2.0", "pid": "amc", "method": "com.attocube.amc.res.getSensorStatus", "params": [%i], "id": 1, "api": 2}', axis);
