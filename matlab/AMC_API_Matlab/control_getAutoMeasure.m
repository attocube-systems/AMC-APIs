...
function [errNo, value_enable] = control_getAutoMeasure(tcp, axis)
...
data_send = sprintf('{"jsonrpc": "2.0", "pid": "amc", "method": "com.attocube.amc.control.getAutoMeasure", "params": [%i], "id": 1, "api": 2}', axis);
