...
function [errNo, value_enable] = rtin_getControlMoveGPIO(tcp, axis)
...
data_send = sprintf('{"jsonrpc": "2.0", "pid": "amc", "method": "com.attocube.amc.rtin.getControlMoveGPIO", "params": [%i], "id": 1, "api": 2}', axis);
