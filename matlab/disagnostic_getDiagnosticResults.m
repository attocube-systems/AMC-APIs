function [errNo, capacity, resistance] = disagnostic_getDiagnosticResults(tcp, axis)
...
data_send = sprintf('{"jsonrpc": "2.0", "method": "com.attocube.amc.disagnostic.getDiagnosticResults", "params": [%i], "id": 1, "api": 2}', axis);
