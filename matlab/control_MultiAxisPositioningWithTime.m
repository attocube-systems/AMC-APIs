...
data_send = sprintf('{"jsonrpc": "2.0", "method": "com.attocube.amc.control.MultiAxisPositioningWithTime", "params": [%i, %i, %i, %i, %i, %i], "id": 1, "api": 2}', set1, set2, set3, target1, target2, target3);
