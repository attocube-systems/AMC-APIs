function [errNo, inverted] = control_getSensorDirection(tcp, axis)
% brief : This function gets whether the IDS sensor source of closed loop is inverted
