...
<Library LVVersion="16008000">
	...
	<Item Name="Discovery" Type="Folder">
		<Item Name="32 Bit" Type="Folder">
			<Item Name="attocube-discovery-dll.dll" Type="Document" URL="../Discovery/32 Bit/attocube-discovery-dll.dll"/>
		</Item>
		<Item Name="64 bit" Type="Folder">
			<Item Name="attocube-discovery-dll.dll" Type="Document" URL="../Discovery/64 bit/attocube-discovery-dll.dll"/>
		</Item>
		<Item Name="AMC_discover_devices_SubVI.vi" Type="VI" URL="../Discovery/AMC_discover_devices_SubVI.vi"/>
	</Item>
</Library>
